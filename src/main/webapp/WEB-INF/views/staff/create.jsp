...
<div class="w-full max-w-2xl bg-white rounded-lg shadow-md p-6">
    <h1 class="text-2xl font-bold mb-6 text-green-700">Create New Staff</h1>
    ...
    <form id="staffForm" class="space-y-4">
        ...
        <div>
            ...
            <p id="nicError" class="text-red-500 text-xs mt-1 hidden">Enter a valid NIC (e.g., 941234567V).</p>
        </div>
        ...
        <div>
            ...
            <input type="date" id="joinedDate"
                   class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500">
            <p id="dateError" class="text-red-500 text-xs mt-1 hidden">Enter a valid date.</p>
        </div>
        ...
        <div>
            ...
            <p id="salaryError" class="text-red-500 text-xs mt-1 hidden">Enter a valid salary.</p>
        </div>
