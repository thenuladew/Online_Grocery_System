                ...
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    <table class="min-w-full">
                        ...
                        <tr>
                            ...
                            <td id="subtotal" class="py-3 px-4 font-bold text-green-700 text-right">$0.00</td>
                        </tr>
                        <tr>
                            <td colspan="4" class="text-right py-3 px-4 font-semibold text-gray-700">Shipping:</td>
                            <td id="shipping" class="py-3 px-4 font-bold text-green-700 text-right">$5.00</td>
                        </tr>
                        <tr class="bg-green-50">
                            <td colspan="4" class="text-right py-4 px-4 font-bold text-gray-800">Grand Total:</td>
                            <td id="grandTotal" class="py-4 px-4 font-bold text-xl text-green-700 text-right">$0.00</td>
                        </tr>
                        </tfoot>
                    </table>
                </div>
...
<script>
        ...
        if (items.length === 0) {
            ...
            items.forEach(function (item) {
                ...
                row.innerHTML =
                    ...
                    "<td class='py-3 px-4 border-b text-right'>$" + itemTotal + "</td>";
    ...
    function submitOrder() {
        ...
        fetch("/api/customers/" + encodeURIComponent(currentUserId))
            .then(function (response) {
                return response.json();
            })
